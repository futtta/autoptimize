...
if ( ! autoptimizeUtils::is_plugin_active( 'autoptimize-criticalcss/ao_criticss_aas.php' ) && ! autoptimizeUtils::is_plugin_active( 'autoptimize-criticalcss/autoptimizeCriticalCssMain.php' ) ) {
    echo ' ';
