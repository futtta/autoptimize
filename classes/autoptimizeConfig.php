...
<?php
    ...
    public function addmenu()
    {
        ...
        } elseif ( is_multisite() && ! is_network_admin() && autoptimizeOptionWrapper::is_ao_active_for_network() && 'off' === autoptimizeOptionWrapper::get_option( 'autoptimize_enable_site_config' ) ) {
