...
class autoptimizeCriticalCSSSettings {
    ...
    public function run()
    {
        if ( $this->enabled() ) {
            ...
            $autoptimizeCriticalCSSAjax = new autoptimizeCriticalCSSSettingsAjax();
        }
    }
    ...
    public function admin_assets( $hook ) {
        ...
        if( $hook != 'settings_page_ao_critcss') {
            return;
        }
        ...
        <div class="wrap">
            <div id="autoptimize_main">
                ...
                if ( $_warn_cron == "on" && PAnD::is_admin_notice_active( 'i-know-about-cron-1' ) ) {
                    ...
                    ?></p></div><?php
                } else if ( $ao_ccss_keyst == '2' && $_warn_cron != "on" && ! $this->ao_ccss_has_autorules() ) {
